      ...
      <div className="w-full max-w-md glass-panel p-10 rounded-2xl relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-sm text-gray-400">
            Authenticate to sequence your matrix
          </p>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleLogin}>
          ...
          <div className="space-y-5">
            <div>
              <label className="block text-sm font-medium text-gray-300 mb-1.5">Communication Node</label>
          ...
          <div className="text-center text-sm mt-6">
            <span className="text-gray-400">Unregistered entity? </span>
